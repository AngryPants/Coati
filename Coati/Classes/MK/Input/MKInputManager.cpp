...
void MKInputManager::InitializeDefinitions()
{
    ...
    // Start Game (Touch/Mouse)
    {
        ...
        m_InputDefinitions[MKInputName::START_GAME]->Register(
    ...
    // Jumping (Keyboard)
	{
		mkU64 inputMask = MKInputManager::GenerateMask(MK_INPUT_CONTEXT_GAMEPLAY, MK_CONTROLLER_1, (mkU32)EventKeyboard::KeyCode::KEY_UP_ARROW);
    ...
    // Sliding (Keyboard)
    {
        mkU64 inputMask = MKInputManager::GenerateMask(MK_INPUT_CONTEXT_GAMEPLAY, MK_CONTROLLER_1, (mkU32)EventKeyboard::KeyCode::KEY_DOWN_ARROW);
